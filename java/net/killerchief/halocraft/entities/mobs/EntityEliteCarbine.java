...
public class EntityEliteCarbine extends EntityHalocraftMob implements IRangedAttackMob
{
	/** The ItemStack the Elite Holds. */
	private static final ItemStack defaultHeldItem = new ItemStack(HalocraftItemsWeapons.Carbine, 1);
	...
	public EntityEliteCarbine(World par1World)
	{
		...
		tasks.addTask(2, new EntityAIShootAttack(this, this.runSpeed, 12, 50F)); //(Mob, MoveSpeed, ShootSpeed, WithinDistanceToShoot)
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		for (int l = 0; l < i; l++)
		{
			dropItem(HalocraftItemsWeapons.Carbine, 1);
		}
	}
