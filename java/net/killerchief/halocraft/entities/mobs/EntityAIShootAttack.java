...
public class EntityAIShootAttack extends EntityAIBase
{
    ...
    public EntityAIShootAttack(IRangedAttackMob p_i1649_1_, double p_i1649_2_, int p_i1649_4_, float p_i1649_5_)
    {
        this(p_i1649_1_, p_i1649_2_, p_i1649_4_, p_i1649_4_, p_i1649_5_);
    }

    public EntityAIShootAttack(IRangedAttackMob mob, double movespeed, int shootspeed, int p_i1650_5_, float p_i1650_6_)
    {
        ...
        else
        {
            ...
            this.entityHost = (EntityLiving)mob;
            this.entityMoveSpeed = movespeed;
            this.field_96561_g = shootspeed;
    ...
    public boolean shouldExecute()
    {
        ...
        else if (entitylivingbase instanceof EntityEliteCarbine || entitylivingbase instanceof EntityElitePlasmaRifle || entitylivingbase instanceof EntityGruntPlasmaPistol)
        {
    ...
    public void updateTask()
    {
        ...
        this.entityHost.getLookHelper().setLookPositionWithEntity(this.attackTarget, 30.0F, 30.0F);//Aim Adjustment?
        float f;
