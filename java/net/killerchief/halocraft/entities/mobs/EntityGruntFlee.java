...
public class EntityGruntFlee extends EntityGruntBase {
	...
	public EntityGruntFlee(World par1World) {
        ...
        this.tasks.addTask(1, new EntityAIPanic(this, this.runSpeed));
        this.tasks.addTask(2, new EntityAIWander(this, this.movementSpeed));
        for (int i = 0; i < mobWatchList.length; i++)
        	this.tasks.addTask(3, new EntityAIWatchClosest(this, mobWatchList[i], 6.0F));
