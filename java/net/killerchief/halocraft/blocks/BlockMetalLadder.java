...
public class BlockMetalLadder extends HalocraftBlock
{
	public BlockMetalLadder(String name, String texture, Material material, int harvestLevel)
	{
		super(name, texture, material, harvestLevel);
	}
	...
	{
		this.updateLadderBounds(p_149719_1_.getBlockMetadata(p_149719_2_, p_149719_3_, p_149719_4_));
	}
	...
	public void updateLadderBounds(int p_149797_1_)
	{
		float f = 0.125F;
