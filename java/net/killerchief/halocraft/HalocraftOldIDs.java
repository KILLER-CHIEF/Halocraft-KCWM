...
public class HalocraftOldIDs {
	...
	public void load(FMLInitializationEvent event)
	{
		...
		MarkVHelmetBlack = (new HalocraftOldItem("MarkVHelmetBlack", HalocraftItemsArmor.MarkVHelmetBlack));
		MarkVBodyBlack = (new HalocraftOldItem("MarkVBodyBlack", HalocraftItemsArmor.MarkVBodyBlack));
		MarkVLegsBlack = (new HalocraftOldItem("MarkVLegsBlack", HalocraftItemsArmor.MarkVLegsBlack));
		MarkVBootsBlack = (new HalocraftOldItem("MarkVBootsBlack", HalocraftItemsArmor.MarkVBootsBlack));
		MarkVHelmetGreen = (new HalocraftOldItem("MarkVHelmetGreen", HalocraftItemsArmor.MarkVHelmetGreen));
		MarkVBodyGreen = (new HalocraftOldItem("MarkVBodyGreen", HalocraftItemsArmor.MarkVBodyGreen));
		MarkVLegsGreen = (new HalocraftOldItem("MarkVLegsGreen", HalocraftItemsArmor.MarkVLegsGreen));
		MarkVBootsGreen = (new HalocraftOldItem("MarkVBootsGreen", HalocraftItemsArmor.MarkVBootsGreen));
		MarkVHelmetBlue = (new HalocraftOldItem("MarkVHelmetBlue", HalocraftItemsArmor.MarkVHelmetBlue));
		MarkVBodyBlue = (new HalocraftOldItem("MarkVBodyBlue", HalocraftItemsArmor.MarkVBodyBlue));
		MarkVLegsBlue = (new HalocraftOldItem("MarkVLegsBlue", HalocraftItemsArmor.MarkVLegsBlue));
		MarkVBootsBlue = (new HalocraftOldItem("MarkVBootsBlue", HalocraftItemsArmor.MarkVBootsBlue));
		MarkVHelmetRed = (new HalocraftOldItem("MarkVHelmetRed", HalocraftItemsArmor.MarkVHelmetRed));
		MarkVBodyRed = (new HalocraftOldItem("MarkVBodyRed", HalocraftItemsArmor.MarkVBodyRed));
		MarkVLegsRed = (new HalocraftOldItem("MarkVLegsRed", HalocraftItemsArmor.MarkVLegsRed));
		MarkVBootsRed = (new HalocraftOldItem("MarkVBootsRed", HalocraftItemsArmor.MarkVBootsRed));
		...
		MarkVIHelmetGreen = (new HalocraftOldItem("MarkVIHelmetGreen", HalocraftItemsArmor.MarkVIHelmetGreen));
		MarkVIBodyGreen = (new HalocraftOldItem("MarkVIBodyGreen", HalocraftItemsArmor.MarkVIBodyGreen));
		MarkVILegsGreen = (new HalocraftOldItem("MarkVILegsGreen", HalocraftItemsArmor.MarkVILegsGreen));
		MarkVIBootsGreen = (new HalocraftOldItem("MarkVIBootsGreen", HalocraftItemsArmor.MarkVIBootsGreen));
		ReconHelmet = (new HalocraftOldItem("ReconHelmet", HalocraftItemsArmor.ReconHelmet));
		ReconBody = (new HalocraftOldItem("ReconBody", HalocraftItemsArmor.ReconBody));
		ReconLegs = (new HalocraftOldItem("ReconLegs", HalocraftItemsArmor.ReconLegs));
		ReconBoots = (new HalocraftOldItem("ReconBoots", HalocraftItemsArmor.ReconBoots));
