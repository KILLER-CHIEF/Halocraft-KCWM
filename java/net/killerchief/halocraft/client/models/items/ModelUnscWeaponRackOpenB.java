...
public class ModelUnscWeaponRackOpenB extends Model3DBase
{
	int textureX = 512;
	int textureY = 512;

	public ModelUnscWeaponRackOpenB()
	{
		...
		bodyModel[17] = new ModelRendererTurbo(this, 425, 25, textureX, textureY); // Box 19
		...
		bodyModel[17].addBox(0.5F, 0F, 0F, 0, 2, 14, 0F); // Box 19
		bodyModel[17].setRotationPoint(-8F, -14F, -7F);

		bodyModel[18].addBox(0.5F, 0F, 0F, 0, 26, 14, 0F); // Box 20
