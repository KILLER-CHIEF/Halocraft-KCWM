...
public class GuiCovSupplyCase extends GuiContainer
{
	private static final ResourceLocation texture = new ResourceLocation(Halocraft.MODID+":textures/gui/CovSupplyCase.png");
	private TileEntityCovSupplyCase tileEntity;

	public GuiCovSupplyCase(InventoryPlayer inventoryplayer, TileEntityCovSupplyCase tileentity, boolean outer, boolean frontSide)
	{
