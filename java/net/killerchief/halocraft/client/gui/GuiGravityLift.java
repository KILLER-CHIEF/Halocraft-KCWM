...
public class GuiGravityLift extends GuiContainer {
	...
	private static final ResourceLocation texture = new ResourceLocation(Halocraft.MODID+":textures/gui/GravityLift.png");
	...
	public GuiGravityLift(InventoryPlayer par1InventoryPlayer, TileEntityGravityLift par2TileEntityGravityLift)
	{
		super(new ContainerGravityLift(par1InventoryPlayer, par2TileEntityGravityLift));
		this.player = par1InventoryPlayer.player;
		this.tileentity = par2TileEntityGravityLift;
		xSize = 176;
		ySize = 154;
	}
	...
	protected void actionPerformed(GuiButton guibutton)
	{
		if (guibutton.id == 1)
		{
			Halocraft.network.sendToServer(new PacketGravityLift(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord, (byte)1, (byte)0));
			if (this.mc.theWorld.getBlock(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord) == HalocraftBlocks.PermanentGravityLiftBaseIdle)
			{
		...
		{
			Halocraft.network.sendToServer(new PacketGravityLift(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord, (byte)2, (byte)0));
			if (this.mc.theWorld.getBlock(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord) == HalocraftBlocks.PermanentGravityLiftBaseActive)
			{
				this.mc.displayGuiScreen(null);
			}
		}
		...
		{
			Halocraft.network.sendToServer(new PacketGravityLift(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord, (byte)3, (byte)0));
			if ((this.mc.theWorld.getBlock(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord) == HalocraftBlocks.PermanentGravityLiftBaseActive && !this.mc.theWorld.isBlockIndirectlyGettingPowered(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord)) || (this.mc.theWorld.getBlock(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord) == HalocraftBlocks.PermanentGravityLiftBaseIdle && this.mc.theWorld.isBlockIndirectlyGettingPowered(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord)))
			{
				this.mc.displayGuiScreen(null);
			}
		}
		...
		else if (guibutton.id == 5)
		{
			if (this.btnLockEditing.displayString.equalsIgnoreCase("Allow Editing")) {
				...
				Halocraft.network.sendToServer(new PacketGravityLift(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord, (byte)-4, (byte)0));
			}
		}
		else if (guibutton.id == 6)
		{
			Halocraft.network.sendToServer(new PacketGravityLift(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord, (byte)0, (byte)5));
		}
		else if (guibutton.id == 7)
		{
			Halocraft.network.sendToServer(new PacketGravityLift(this.tileentity.xCoord, this.tileentity.yCoord, this.tileentity.zCoord, (byte)0, (byte)1));
		}
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
	{
		...
		drawCenteredString(this.fontRendererObj, "Gravity Lift Options", (width / 2), (height / 2) - 65, 0xffffff);
		drawCenteredString(this.fontRendererObj, "Method of Activation", (width / 2) - 25, (height / 2) - 50, 0xffffff);
		drawCenteredString(this.fontRendererObj, ""+this.tileentity.getGravitationalHeight(), (width / 2) + 55, (height / 2) + 3, 0xffffff);
