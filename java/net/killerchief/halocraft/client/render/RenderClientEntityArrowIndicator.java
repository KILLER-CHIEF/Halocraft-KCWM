...
public class RenderClientEntityArrowIndicator extends Render {
	...
	ResourceLocation Res = new ResourceLocation(Halocraft.MODID+":textures/overlays/ArrowIndicator.png");
