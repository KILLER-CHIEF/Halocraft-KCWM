...
public class HalocraftItemsArmor {
	...
	public static void load(Configuration config) {
		...
		MarkVHelmetBlack = new ItemCustomArmor("MarkVHelmetBlack", "MarkVHelmetBlack", 1, Halocraft.MODID+":textures/armor/MarkVBlack.png", 0, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"), true, Halocraft.MODID+":textures/overlays/MarkVHelmetZoomOverlay.png");
		MarkVBodyBlack = new ItemCustomArmor("MarkVBodyBlack", "MarkVBodyBlack", 1, Halocraft.MODID+":textures/armor/MarkVBlack.png", 1, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVLegsBlack = new ItemCustomArmor("MarkVLegsBlack", "MarkVLegsBlack", 1, Halocraft.MODID+":textures/armor/MarkVBlack.png", 2, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVBootsBlack = new ItemCustomArmor("MarkVBootsBlack", "MarkVBootsBlack", 1, Halocraft.MODID+":textures/armor/MarkVBlack.png", 3, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVHelmetGreen = new ItemCustomArmor("MarkVHelmetGreen", "MarkVHelmetGreen", 1, Halocraft.MODID+":textures/armor/MarkVGreen.png", 0, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"), true, Halocraft.MODID+":textures/overlays/MarkVHelmetZoomOverlay.png");
		MarkVBodyGreen = new ItemCustomArmor("MarkVBodyGreen", "MarkVBodyGreen", 1, Halocraft.MODID+":textures/armor/MarkVGreen.png", 1, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVLegsGreen = new ItemCustomArmor("MarkVLegsGreen", "MarkVLegsGreen", 1, Halocraft.MODID+":textures/armor/MarkVGreen.png", 2, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVBootsGreen = new ItemCustomArmor("MarkVBootsGreen", "MarkVBootsGreen", 1, Halocraft.MODID+":textures/armor/MarkVGreen.png", 3, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVHelmetBlue = new ItemCustomArmor("MarkVHelmetBlue", "MarkVHelmetBlue", 1, Halocraft.MODID+":textures/armor/MarkVBlue.png", 0, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"), true, Halocraft.MODID+":textures/overlays/MarkVHelmetZoomOverlay.png");
		MarkVBodyBlue = new ItemCustomArmor("MarkVBodyBlue", "MarkVBodyBlue", 1, Halocraft.MODID+":textures/armor/MarkVBlue.png", 1, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVLegsBlue = new ItemCustomArmor("MarkVLegsBlue", "MarkVLegsBlue", 1, Halocraft.MODID+":textures/armor/MarkVBlue.png", 2, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVBootsBlue = new ItemCustomArmor("MarkVBootsBlue", "MarkVBootsBlue", 1, Halocraft.MODID+":textures/armor/MarkVBlue.png", 3, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVHelmetRed = new ItemCustomArmor("MarkVHelmetRed", "MarkVHelmetRed", 1, Halocraft.MODID+":textures/armor/MarkVRed.png", 0, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"), true, Halocraft.MODID+":textures/overlays/MarkVHelmetZoomOverlay.png");
		MarkVBodyRed = new ItemCustomArmor("MarkVBodyRed", "MarkVBodyRed", 1, Halocraft.MODID+":textures/armor/MarkVRed.png", 1, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVLegsRed = new ItemCustomArmor("MarkVLegsRed", "MarkVLegsRed", 1, Halocraft.MODID+":textures/armor/MarkVRed.png", 2, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		MarkVBootsRed = new ItemCustomArmor("MarkVBootsRed", "MarkVBootsRed", 1, Halocraft.MODID+":textures/armor/MarkVRed.png", 3, ArmorMaterial.GOLD, Halocraft.proxy.addArmor("MarkV"));
		...
		MarkVIHelmetGreen = new ItemCustomArmor("MarkVIHelmetGreen", "MarkVIHelmetGreen", 0, Halocraft.MODID+":textures/armor/MarkVIGreen.png", 0, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("MarkVI"), true, Halocraft.MODID+":textures/overlays/MarkVIHelmetZoomOverlay.png");
		MarkVIBodyGreen = new ItemCustomArmor("MarkVIBodyGreen", "MarkVIBodyGreen", 0, Halocraft.MODID+":textures/armor/MarkVIGreen.png", 1, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("MarkVI"));
		MarkVILegsGreen = new ItemCustomArmor("MarkVILegsGreen", "MarkVILegsGreen", 0, Halocraft.MODID+":textures/armor/MarkVIGreen.png", 2, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("MarkVI"));
		MarkVIBootsGreen = new ItemCustomArmor("MarkVIBootsGreen", "MarkVIBootsGreen", 0, Halocraft.MODID+":textures/armor/MarkVIGreen.png", 3, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("MarkVI"));
		ReconHelmet = new ItemCustomArmor("ReconHelmet", "ReconHelmet", 0, Halocraft.MODID+":textures/armor/Recon.png", 0, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("Recon"), true, Halocraft.MODID+":textures/overlays/ReconHelmetZoomOverlay.png");
		ReconBody = new ItemCustomArmor("ReconBody", "ReconBody", 0, Halocraft.MODID+":textures/armor/Recon.png", 1, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("Recon"));
		ReconLegs = new ItemCustomArmor("ReconLegs", "ReconLegs", 0, Halocraft.MODID+":textures/armor/Recon.png", 2, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("Recon"));
		ReconBoots = new ItemCustomArmor("ReconBoots", "ReconBoots", 0, Halocraft.MODID+":textures/armor/Recon.png", 3, ArmorMaterial.DIAMOND, Halocraft.proxy.addArmor("Recon"));
	}
