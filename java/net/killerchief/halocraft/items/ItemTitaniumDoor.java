...
public class ItemTitaniumDoor extends HalocraftItem {

	private int Type;
	private boolean Locked;

	public ItemTitaniumDoor(String name, String texture, int type, boolean locked) {
		super(name, texture);
		this.Type = type;
		this.Locked = locked;
	}
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
	{
		...
		else
		{
			...
			{
				if (this.Locked)
					block = HalocraftBlocks.ForerunnerDoorLockedBlock;
				else
					block = HalocraftBlocks.ForerunnerDoorBlock;
			}
			else
			{
				if (this.Locked)
					block = HalocraftBlocks.HumanDoorLockedBlock;
				else
					block = HalocraftBlocks.HumanDoorBlock;
			}
